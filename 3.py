...
def Collision2(Enemy_1X, Enemy_1Y, BulletX, BulletY):
    distance = math.sqrt((math.pow((Enemy_1X+3) - BulletX, 2)) + (math.pow(Enemy_1Y - BulletY, 2)))
    if distance < 27:
        return True
    else:
        return False

def Collision3(Enemy_2X, Enemy_2Y, BulletX, BulletY):
    distance = math.sqrt((math.pow((Enemy_2X+3) - BulletX, 2)) + (math.pow(Enemy_2Y - BulletY, 2)))
    if distance < 27:
        return True
    else:
        return False
...
# Collision2
    ...
    # Collision3
    collision3 = Collision3(Enemy_2X, Enemy_2Y, BulletX, BulletY)
